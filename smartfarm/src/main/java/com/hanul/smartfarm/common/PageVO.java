...
public class PageVO {
	...
	private int blockPage = 3; 		// 블럭당 보여질 페이지의 수 (수정된 부분)
	...
	private List<Object> list;		// 각 페이지의 글 목록
	private String search, keyword = "";
	
	public void setTotalList(int totalList) {
		this.totalList = totalList;
		
		// 총 페이지수 : 총 목록수 / 페이지당 보여질 목록수 - 나머지 있으면 1증가
		totalPage = totalList / pageList;
		if( totalList % pageList > 0 ) ++totalPage;
		// 총 블록수 : 총 페이지수 / 블럭당 보여질 페이지수 - 나머지 있으면 1증가
		...
		// 블록번호 : 페이지번호 / 블록당 보여질 페이지수 - 나머지 있으면 1증가
